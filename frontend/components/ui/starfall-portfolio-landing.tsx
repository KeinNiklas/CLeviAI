...
// --- DEFAULT DATA ---
const defaultData: {
    logo: Required<PortfolioPageProps>['logo'];
    navLinks: Required<PortfolioPageProps>['navLinks'];
    resume: Required<PortfolioPageProps>['resume'];
    hero: Required<PortfolioPageProps>['hero'];
    ctaButtons: Required<PortfolioPageProps>['ctaButtons'];
    projects: Required<PortfolioPageProps>['projects'];
    stats: Required<PortfolioPageProps>['stats'];
} = {
...
// Export the animated background as a standalone component for use in other pages
export { AuroraBackground as StarfallAuroraBackground };
